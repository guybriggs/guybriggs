...
import { FridgeSystem } from './modules/systems/FridgeSystem.js';
import { GoalMovementSystem } from './modules/systems/GoalMovementSystem.js';

import { MovementCooldownComponent } from './modules/components/MovementCooldown.js';
import { MovementSpeedModifierComponent } from './modules/components/MovementSpeedModifier.js';
import { RandomlyMoveComponent } from './modules/components/RandomlyMove.js';
import { InventoryComponent } from './modules/components/Inventory.js';
...
let world,
    ...
    apartmentSystem, tradeSystem,workerAssignmentSystem, collisionSystem, fridgeSystem, goalMovementSystem, talkInteractionSystem;
...
window.setup = function() {
  ...
  tradeSystem = new TradeSystem(world, buildingSystem);
  workerAssignmentSystem = new WorkerAssignmentSystem();
  fridgeSystem = new FridgeSystem(world, buildingSystem);
  ...
  world.addComponent(followerEntity, 'Renderable', { radius: 8, color: 'white' });
  world.addComponent(followerEntity, 'Emotion', { type: EmotionTypes.HAPPY });
  world.addComponent(followerEntity, 'Name', { firstName: '' });
  ...
  world.addComponent(followerEntity, 'MovementCooldown', MovementCooldownComponent());
  world.addComponent(followerEntity, 'MovementSpeedModifier', MovementSpeedModifierComponent());
  world.addComponent(followerEntity, 'RandomlyMove', RandomlyMoveComponent());
  world.addComponent(followerEntity, 'Inventory', InventoryComponent());
  world.addComponent(followerEntity, 'Money', MoneyComponent());
  ...
  // Then spawn your 5 light-blue-hat NPC workers:
  agentManager.createLightBlueNPCWorkers();
