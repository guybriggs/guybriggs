...
export class CollisionSystem {
  ...
  handleSimpleCollision(proposedX, proposedY, vel) {
    ...
    if (tile.type === 'white_bricks' || tile.type === 'stone_bricks') {
      vel.vx = 0;
      vel.vy = 0;
    }
  }
  ...
  handlePlayerCollision(pos, vel) {
    ...
    if (
      ...
      ['white_bricks', 'stone_bricks'].includes(tileMap[rowCurrent][colX].type)
    ) {
    ...
    if (
      ...
      ['white_bricks', 'stone_bricks'].includes(tileMap[rowY][colCurrent].type)
    ) {
